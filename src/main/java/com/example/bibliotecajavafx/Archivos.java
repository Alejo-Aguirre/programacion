...
import co.uniquindio.model.biblioteca.Autor;
...
public class Archivos {
    ...
    public ArrayList<Autor> leerAutores(){
        ArrayList<Autor> listaAutoresLeida= new ArrayList<>();
        File archivo = null;
        FileReader fr = null;
        ...
        try {
            ...
            while((linea = br.readLine()) != null) {
                ...
                Autor obj = new Autor(lineaDividida[0],lineaDividida[1],LocalDate.parse(lineaDividida[2]));
